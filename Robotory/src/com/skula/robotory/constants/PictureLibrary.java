...
public class PictureLibrary{
	...
	public PictureLibrary(Resources res){
		...
		this.map.put(R.drawable.btn_bstock_p1_01,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_01));
		this.map.put(R.drawable.btn_wstock_p1_01,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_01));
		this.map.put(R.drawable.btn_bstock_p1_02,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_02));
		this.map.put(R.drawable.btn_wstock_p1_02,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_02));
		this.map.put(R.drawable.btn_bstock_p1_03,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_03));
		this.map.put(R.drawable.btn_wstock_p1_03,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_03));
		this.map.put(R.drawable.btn_bstock_p1_04,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_04));
		this.map.put(R.drawable.btn_wstock_p1_04,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_04));
		this.map.put(R.drawable.btn_bstock_p1_05,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_05));
		this.map.put(R.drawable.btn_wstock_p1_05,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_05));
		this.map.put(R.drawable.btn_bstock_p1_06,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_06));
		this.map.put(R.drawable.btn_wstock_p1_06,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_06));
		this.map.put(R.drawable.btn_bstock_p1_07,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_07));
		this.map.put(R.drawable.btn_wstock_p1_07,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_07));
		this.map.put(R.drawable.btn_bstock_p1_08,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_08));
		this.map.put(R.drawable.btn_wstock_p1_08,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_08));
		this.map.put(R.drawable.btn_bstock_p1_09,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_09));
		this.map.put(R.drawable.btn_wstock_p1_09,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_09));
		this.map.put(R.drawable.btn_bstock_p1_10,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_10));
		this.map.put(R.drawable.btn_wstock_p1_10,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_10));
		this.map.put(R.drawable.btn_bstock_p1_11,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_11));
		this.map.put(R.drawable.btn_wstock_p1_11,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_11));
		this.map.put(R.drawable.btn_bstock_p1_12,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_12));
		this.map.put(R.drawable.btn_wstock_p1_12,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_12));
		this.map.put(R.drawable.btn_bstock_p1_13,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_13));
		this.map.put(R.drawable.btn_wstock_p1_13,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_13));
		this.map.put(R.drawable.btn_bstock_p1_14,		BitmapFactory.decodeResource(res, R.drawable.btn_bstock_p2_14));
		this.map.put(R.drawable.btn_wstock_p1_14,		BitmapFactory.decodeResource(res, R.drawable.btn_wstock_p2_14));
